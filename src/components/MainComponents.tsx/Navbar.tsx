        ...
        <nav className="bg-main shadow-lg">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <Link href="/">
                            <Image src="/nike.avif" alt="Logo" width={80} height={40} />
                        </Link>
                    </div>
                    ...
                    <div className="hidden lg:block">
                        <div className="ml-10 flex items-baseline space-x-4">
                            ...
                            <Link href="/snkrs" className="text-black hover:bg-gray-200 px-3 py-2 rounded-md text-sm font-medium">
                                SNKRS
                            </Link>
                        </div>
                    </div>

                    {/* Search, Heart Icon, Cart Icon, and User Menu */}
                    <div className="hidden lg:flex items-center space-x-4">
                        <div className="relative" ref={searchRef}>
                            <SearchBar />
                        </div>
                        <Link href="/wishlist" className="text-gray-700 hover:text-gray-900 focus:outline-none relative">
                            <FaRegHeart size={20} />
                        ...
                        <Link href="/cart" className="text-gray-700 hover:text-gray-900 focus:outline-none relative">
            ...
            {isHamburgerOpen && (
                <div ref={mobileMenuRef} className="lg:hidden">
                     <div className="pt-4 flex justify-between items-center pb-3 border-t border-b border-gray-700">
                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <Link href="/snkrs" className="text-black block hover:bg-gray-200 px-3 py-2 rounded-md text-base font-medium">
                            SNKRS
                        </Link>
                    </div>
